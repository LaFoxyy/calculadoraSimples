...
import calc.escravo.controller.EscravoEspecialController;
 ...
 * @author guilh
 */
public class EscravoEspecialMain extends javax.swing.JFrame {

    
    private EscravoEspecialController controller;
    
    
    /**
     * Creates new form EscravoEspecialMain
     */
    public EscravoEspecialMain() {
        
        controller = new EscravoEspecialController();
    ...
    private void initComponents() {
        ...
        btn_conexao.setText("Conectar Server Especial");
        btn_conexao.setToolTipText("");
    ...
    private void btn_conexaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_conexaoActionPerformed
        ...
        if (controller.getServer() == null) {
            ...
            btn_conexao.setText("Desconectar Server Especial");
        } else {
    ...
    public static void main(String args[]) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    EscravoEspecialMain window = new EscravoEspecialMain();
